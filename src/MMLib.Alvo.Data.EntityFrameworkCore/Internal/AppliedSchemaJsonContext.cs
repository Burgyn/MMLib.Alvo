...
/// <see cref="EfCoreDescriptorVersionStore"/> to (de)serialize the <c>schema_json</c> column
/// without reflection-based System.Text.Json (avoids trim/AOT warnings under TreatWarningsAsErrors).
/// </summary>
