...
**running application** found that neither could. Six things, each discovered by driving the
dashboard rather than by reading it, and each recorded here because the next person to touch this
surface will otherwise rediscover them the same way.
