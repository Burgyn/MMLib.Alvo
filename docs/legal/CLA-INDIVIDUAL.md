...
> **Plain-language summary (not part of the agreement):** You keep the copyright to
> everything you contribute. You grant a broad license (§2.3, the Harmony "any licence"
> option) that lets the project be relicensed — including commercially — in the future
> without asking you again, while the core stays Apache-2.0. Signing is a one-time
> electronic acceptance through the [CLA Assistant](https://cla-assistant.io/) bot on
> your first pull request.
>
> This document is the **Harmony Individual Contributor License Agreement (HA-CLA-I),
> Version 1.0, "any licence" variant**, adapted only to name the project and maintainer,
> the submission method, and the governing law. It is a recognised, widely-used template —
> not a bespoke draft — but it is **not** a substitute for your own legal advice.

---

Thank you for your interest in contributing to MMLib.Alvo and other software projects
managed by Miňo Martiniak (mino.martiniak@gmail.com) ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to
Us. To make this document effective, please accept it electronically through the
[CLA Assistant](https://cla-assistant.io/) bot, following the instructions in
[`CONTRIBUTING.md`](../../CONTRIBUTING.md). This is a legally binding document, so please
read it carefully before agreeing to it. The Agreement may cover more than one software
...
authorship to which the Contribution was Submitted. After You Submit the Contribution, it
...
use or license the Contribution which You would have had without entering into the Agreement.
...
Contribution in combination with the Material (and portions of such combination). This
license is granted only to the extent that the exercise of the licensed rights infringes such
patent claims; and provided that this license is conditioned upon compliance with Section 2.3.
...
to also license the Contribution under the terms of the license or licenses which We are
using for the Material on the Submission Date.
...
employer approve this Agreement or sign the Entity version of this document
([`CLA-CORPORATE.md`](CLA-CORPORATE.md)). If You are less than eighteen years old, please
have Your parents or guardian sign the Agreement.

(d) You have followed the instructions in [`CONTRIBUTING.md`](../../CONTRIBUTING.md), if You
...
**You** — your name and GitHub identity are recorded electronically by the CLA Assistant bot
when you accept this Agreement on your first pull request.

**Us** — Miňo Martiniak, mino.martiniak@gmail.com

---

*Based on the [Harmony Individual Contributor License Agreement (HA-CLA-I) Version 1.0](https://www.harmonyagreements.org/),
"any licence" variant. The Harmony Agreements are licensed under a Creative Commons
Attribution 3.0 Unported License. This adaptation changes only the named project and
maintainer, the submission method, and the governing law. It has not been reviewed by a
lawyer on Your behalf — please seek Your own legal counsel before signing.*
