...
Split the arguments first: a bare language code (`sk`, `en`) among them selects the
page's language, **defaulting to `en`**; whatever remains is the PR number or
branch. So `174 sk`, `sk` and `174` are all unambiguous.
